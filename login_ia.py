...
from chatbot_ia import ChatWindow
from ttkthemes import ThemedStyle

class LoginApp:
    def __init__(self, root, crud_instance):#inicializacion de la ventana de inicio de sesion
        self.root = root
        self.root.title("Inicio de Sesión")
        self.root.geometry("500x450")
        self.crud_instance = crud_instance

        original_bg_image = Image.open("C:\\Users\\PAUL\\Desktop\\python\\Desarrollo_chatbot\\images\\aa.jpg")
        ...
        self.logo_image = tk.PhotoImage(file="C:\\Users\\PAUL\\Desktop\\python\\Desarrollo_chatbot\\images\\bot4.png")
    ...
    def iniciar_sesion(self): #manejo del inicio de sesion
...
class RegistroApp:
    def __init__(self, root, login_instance):#Inicializacion de la ventana registro
        ...
        try:
            self.logo_image = tk.PhotoImage(file="C:\\Users\\PAUL\\Desktop\\python\\Desarrollo_chatbot\\images\\registro.png")
    ...
    def registrarse(self, nombres_entry, apellidos_entry, correo_entry, contrasena_entry):#proceso de registro
